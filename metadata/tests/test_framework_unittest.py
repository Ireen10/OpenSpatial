...
class TestFramework(unittest.TestCase):
    ...
    def test_config_loader_discovers_demo(self):
        ...
        self.assertTrue(any(p.endswith("demo_dataset.yaml") for p in paths))

        ds = load_dataset_config("metadata/configs/datasets/demo_dataset.yaml")
        resolve_adapter(ds)
    ...
    def test_cli_io(self):
        ...
        try:
            ...
            args = [
                "--config-root",
                "metadata/configs/datasets/demo_dataset.yaml",
                "--global-config",
            ...
            jsonl_out = out_root / "demo_dataset" / "train_jsonl" / "jsonl_shard_small.out.jsonl"
            ...
            parts = sorted(json_out_dir.glob("part-*.jsonl"))
    ...
    def test_cli_multi_jsonl_shards_separate_outputs(self):
        ...
        try:
            ...
            out_a = split_dir / "jsonl_shard_alpha.out.jsonl"
            out_b = split_dir / "jsonl_shard_beta.out.jsonl"
